...
extern JS_PUBLIC_API char* JS_smprintf_unsafe(const char* fmt, ...);

extern JS_PUBLIC_API JS::UniqueChars JS_sprintf_append(JS::UniqueChars&& last,
                                                       const char* fmt, ...)
    MOZ_FORMAT_PRINTF(2, 3);

extern JS_PUBLIC_API char* JS_sprintf_append_unsafe(char* last, const char* fmt,
                                                    ...);

extern JS_PUBLIC_API JS::UniqueChars JS_vsmprintf(const char* fmt, va_list ap)
    MOZ_FORMAT_PRINTF(1, 0);

extern JS_PUBLIC_API char* JS_vsmprintf_unsafe(const char* fmt, va_list ap);
