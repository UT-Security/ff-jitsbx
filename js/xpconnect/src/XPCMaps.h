...
class JSObject2WrappedJSMap {
  using Map = js::HashMap<JS::sandbox::Heap<JSObject*>, nsXPCWrappedJS*,
                          js::StableCellHasher<JS::sandbox::Heap<JSObject*>>,
...
class JSObject2JSObjectMap {
  using Map = JS::GCHashMap<JS::sandbox::Heap<JSObject*>, JS::sandbox::Heap<JSObject*>,
                            js::StableCellHasher<JS::sandbox::Heap<JSObject*>>,
