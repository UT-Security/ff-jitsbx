...
static nsresult UnwrapDOMObject(JS::Handle<JS::Value> aHandle, void** aObj, MCContext* aCx)
{
  RefPtr<T> p;
...
template<typename T>
static bool WrapDOMObject(MCContext* aCx, void* aObj, JS::MutableHandle<JS::Value> aHandle)
{
