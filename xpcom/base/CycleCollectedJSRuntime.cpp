...
static void JSObjectsTenuredCb_(JSContext* aContext, void* aData) {
...
struct ClearJSHolder : public TraceCallbacks {
  ...
  virtual void Trace(JS::sandbox::Heap<JS::Value>* aPtr, const char*,
                     void*) const override {
    aPtr->setUndefined();
  }
  ...
  virtual void Trace(JS::sandbox::Heap<JSObject*>* aPtr, const char*,
                     void*) const override {
    *aPtr = nullptr;
  }
