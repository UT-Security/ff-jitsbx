...
void AudioWorkletGlobalScope::RegisterProcessor(
  ...
  MC::Rooted<JSObject*> processorConstructor(aCx,
   ...
   */
  MC::Rooted<JS::Value> descriptors(aCx);
...
bool AudioWorkletGlobalScope::ConstructProcessor(
  ...
  MC::Rooted<JS::Value> deserializedOptions(aCx);
  ...
  MC::Rooted<JSObject*> options(aCx, &deserializedOptions.toObject());
  ...
  MC::Rooted<JS::Value> processorVal(aCx);
