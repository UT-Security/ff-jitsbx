...
TEST_F(MP4MetadataTelemetryFixture, Telemetry) {
  ...
  auto CheckHistograms =
      [this, &cx](
        ...
        MC::Rooted<JS::Value> multipleCodecsHistogram(cx.GetJSContext());
        ...
        MC::Rooted<JS::Value> multipleCryptoHistogram(cx.GetJSContext());
        TelemetryTestHelpers::GetProperty(
            cx.GetJSContext(),
        ...
        MC::Rooted<JS::Value> numSamplesHistogram(cx.GetJSContext());
        TelemetryTestHelpers::GetProperty(
