...
IdentityCredential::PromptUserToSelectProvider(
  ...
  MC::Rooted<JS::Value> providersJS(jsapi.cx());
  ...
  MC::Rooted<JS::Value> manifestsJS(jsapi.cx());
...
IdentityCredential::PromptUserToSelectAccount(
  ...
  MC::Rooted<JS::Value> accountsJS(jsapi.cx());
  ...
  MC::Rooted<JS::Value> providerJS(jsapi.cx());
  ...
  MC::Rooted<JS::Value> manifestJS(jsapi.cx());
      ...
      ->Then(
          ...
          [aAccount, aManifest, aProvider, argumentPrincipal, browsingContext,
           ...
           idpPrincipal](const IdentityProviderClientMetadata& metadata)
            ...
            MC::Rooted<JS::Value> metadataJS(jsapi.cx());
