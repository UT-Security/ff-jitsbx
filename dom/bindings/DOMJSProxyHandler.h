...
class BaseDOMProxyHandler : public js::sandbox::BaseProxyHandler {
 public:
#ifdef JS_SANDBOX
  explicit inline BaseDOMProxyHandler(const void* aProxyFamily,
                                         bool aHasPrototype = false)
      : js::sandbox::BaseProxyHandler(aProxyFamily, aHasPrototype) {}
#else
...
inline const DOMProxyHandler* GetDOMProxyHandler(JSObject* obj) {
  ...
  return static_cast<const DOMProxyHandler*>(js::sandbox::GetProxyHandler(obj));
}
