...
class CallbackObject : public nsISupports {
 ...
 protected:
  ...
  MC::Heap<JSObject*> mCallbackGlobal;
  MC::Heap<JSObject*> mCreationStack;
  ...
  class MOZ_STACK_CLASS CallSetup {
   ...
   private:
    ...
    Maybe<MC::Rooted<JSObject*>> mRootedCallable;
    // The global of mRootedCallable.
    Maybe<MC::Rooted<JSObject*>> mRootedCallableGlobal;
