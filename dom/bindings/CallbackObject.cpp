...
void CallbackObject::GetDescription(nsACString& aOutString) {
  ...
  MC::Rooted<JSObject*> unwrappedCallback(
  ...
  MC::Rooted<JSString*> displayId(cx, JS_GetFunctionDisplayId(rootedFunction));
  if (displayId) {
  ...
  MC::Rooted<JSScript*> rootedScript(cx,
...
CallbackObject::CallSetup::CallSetup(CallbackObject* aCallback,
...

  {
    ...
    MC::Rooted<JSObject*> realCallback(ccjs->RootingCx(),
...
bool CallbackObject::CallSetup::ShouldRethrowException(
  ...
  MC::Rooted<JSObject*> obj(mCx, &aException.toObject());
