...
static bool ThrowInvalidThis(JSContext* aCx, const JS::CallArgs& aArgs,
  ...
  JS::sandbox::Rooted<JSFunction*> func(aCx, JS_ValueToFunction(aCx, aArgs.calleev()));
  MOZ_ASSERT(func);
  JS::sandbox::Rooted<JSString*> funcName(aCx, JS_GetFunctionDisplayId(func));
  MOZ_ASSERT(funcName);
...
void TErrorResult<CleanupPolicy>::SetPendingJSException(JSContext* cx) {
  ...
  JS::sandbox::Rooted<JS::Value> exception(cx, mExtra.mJSException);
...
static bool DefineConstructor(JSContext* cx, JS::Handle<JSObject*> global,
  ...
  JS::sandbox::Rooted<JS::PropertyKey> nameKey(cx, JS::PropertyKey::NonIntAtom(nameStr));
...
static JSObject* CreateInterfaceObject(
    ...
    bool isNamespace) {
  JS::sandbox::Rooted<JSObject*> constructor(cx);
  ...
  JS::sandbox::Rooted<jsid> nameStr(cx, JS::PropertyKey::NonIntAtom(name));
  ...
  if (namedConstructors) {
    ...
    while (namedConstructors->mName) {
      JS::sandbox::Rooted<JSObject*> namedConstructor(
...
static JSObject* CreateInterfacePrototypeObject(
    ...
    bool isGlobal) {
  JS::sandbox::Rooted<JSObject*> ourProto(
  ...
  if (unscopableNames) {
    JS::sandbox::Rooted<JSObject*> unscopableObj(
    ...
    JS::sandbox::Rooted<jsid> unscopableId(
...
void CreateInterfaceObjects(
  ...
  JS::sandbox::Rooted<JSString*> nameStr(cx, JS_AtomizeString(cx, name));
  if (!nameStr) {
    return;
  }
...
static bool NativeInterface2JSObjectAndThrowIfFailed(
  ...
  if (cache) {
    JS::sandbox::Rooted<JSObject*> obj(aCx, cache->GetWrapper());
    if (!obj) {
...
bool TryPreserveWrapper(JS::Handle<JSObject*> obj) {
  ...
  JS::sandbox::Rooted<jsid> dummyId(RootingCx());
  JS::sandbox::Rooted<JS::Value> dummyValue(RootingCx());
...
static bool XrayResolveAttribute(
  ...
  JS::sandbox::Rooted<jsid> getterId(cx);
  ...
  if (attrSpec.u.accessors.setter.native.op) {
    JS::sandbox::Rooted<jsid> setterId(cx);
...
/* static */ bool XrayResolveOwnProperty(
  ...
  if (IsInstance(type)) {
    ...
    if (id.isWellKnownSymbol(JS::SymbolCode::toStringTag)) {
      JS::sandbox::Rooted<JSString*> nameStr(
...
void UpdateReflectorGlobal(JSContext* aCx, JS::Handle<JSObject*> aObjArg,
  ...
  JS::sandbox::Rooted<JSObject*> aObj(aCx, aObjArg);
  MOZ_ASSERT(IsDOMObject(aObj));

  const DOMJSClass* domClass = GetDOMClass(aObj);

  JS::sandbox::Rooted<JSObject*> oldGlobal(aCx, JS::GetNonCCWObjectGlobal(aObj));
  MOZ_ASSERT(JS_IsGlobalObject(oldGlobal));

  JS::sandbox::Rooted<JSObject*> newGlobal(aCx,
  ...
  JS::sandbox::Rooted<JSObject*> expandoObject(aCx);
  if (isProxy) {
  ...
  JS::sandbox::Rooted<JSObject*> newobj(aCx, JS_CloneObject(aCx, aObj, proto));
  if (!newobj) {
    aError.StealExceptionFromJSContext(aCx);
    return;
  }
  ...
  JS::sandbox::Rooted<JSObject*> propertyHolder(aCx);
  JS::sandbox::Rooted<JSObject*> copyFrom(aCx, isProxy ? expandoObject : aObj);
  if (copyFrom) {
  ...
  if (propertyHolder) {
    JS::sandbox::Rooted<JSObject*> copyTo(aCx);
    if (isProxy) {
...
GlobalObject::GlobalObject(JSContext* aCx, JSObject* aObject)
  ...
  MOZ_ASSERT(mCx);
  JS::sandbox::Rooted<JSObject*> obj(aCx, aObject);
  if (js::IsWrapper(obj)) {
...
static bool CallOrdinaryHasInstance(JSContext* cx, JS::CallArgs& args) {
  JS::sandbox::Rooted<JSObject*> thisObj(cx, &args.thisv().toObject());
  bool isInstance;
...
static bool InterfaceCheckInstance(JSContext* cx, unsigned argc, JS::Value* vp,
  ...
  JS::sandbox::Rooted<JSObject*> thisObj(
  ...
  JS::sandbox::Rooted<JSObject*> instance(cx, &args[0].toObject());
...
bool GetContentGlobalForJSImplementedObject(BindingCallContext& cx,
  ...
  JS::sandbox::Rooted<JS::Value> domImplVal(cx);
...
void ConstructJSImplementation(const char* aContractId,
  ...
  // properly, since those are never exceptions that a spec wants to be thrown.
  {
    ...
    if (gpi) {
      JS::sandbox::Rooted<JS::Value> initReturn(RootingCx());
...
bool ConvertJSValueToByteString(BindingCallContext& cx, JS::Handle<JS::Value> v,
                                ...
                                nsACString& result) {
  JS::sandbox::Rooted<JSString*> s(cx);
  if (v.isString()) {
    s = v.toString();
  } else {
...
bool GenericGetter(JSContext* cx, unsigned argc, JS::Value* vp) {
  ...
  JS::sandbox::Rooted<JSObject*> obj(cx, ThisPolicy::ExtractThisObject(args));
  ...
  JS::sandbox::Rooted<JSObject*> rootSelf(cx, ThisPolicy::MaybeUnwrapThisObject(obj));
  void* self;
  {
    nsresult rv =
...
static bool GetBackingObject(JSContext* aCx, JS::Handle<JSObject*> aObj,
  ...
  JS::sandbox::Rooted<JS::Value> slotValue(aCx);
...
static inline JSObject* NewObservableArrayProxyObject(
  ...
  JS::sandbox::Rooted<JSObject*> target(aCx, JS::NewArrayObject(aCx, 0));
...
bool ForEachHandler(JSContext* aCx, unsigned aArgc, JS::Value* aVp) {
  ...
  JS::sandbox::Rooted<JS::Value> rval(aCx, JS::UndefinedValue());
...
bool GetDesiredProto(JSContext* aCx, const JS::CallArgs& aCallArgs,
  ...
  JS::sandbox::Rooted<JSObject*> newTarget(aCx, &aCallArgs.newTarget().toObject());
  MOZ_ASSERT(JS::IsCallable(newTarget));
  JS::sandbox::Rooted<JSObject*> originalNewTarget(aCx, newTarget);
  ...
  JS::sandbox::Rooted<JS::Realm*> realm(aCx, JS::GetFunctionRealm(aCx, newTarget));
  if (!realm) {
    return false;
  }
...
bool HTMLConstructor(JSContext* aCx, unsigned aArgc, JS::Value* aVp,
  ...
  JS::sandbox::Rooted<JSObject*> newTarget(
  ...
  // Steps 7 and 8.
  JS::sandbox::Rooted<JSObject*> desiredProto(aCx);
...
void AssertReflectorHasGivenProto(JSContext* aCx, JSObject* aReflector,
  ...
  JS::sandbox::Rooted<JSObject*> givenProto(aCx, aGivenProto);
...
JS::Handle<JSObject*> GetPerInterfaceObjectHandle(
  ...
  if (!protoAndIfaceCache.HasEntryInSlot(aSlotId)) {
    JS::sandbox::Rooted<JSObject*> rootedGlobal(aCx, global);
