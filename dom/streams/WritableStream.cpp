...
void WritableStream::FinishErroring(JSContext* aCx, ErrorResult& aRv) {
  ...
  MC::Rooted<JS::Value> storedError(aCx, mStoredError);
  ...
  MC::Rooted<JS::Value> abortReason(aCx, mPendingAbortRequestReason);
...
void WritableStream::RejectCloseAndClosedPromiseIfNeeded() {
  ...
  MC::Rooted<JS::Value> storedError(RootingCx(), mStoredError);
...
already_AddRefed<WritableStream> WritableStream::Constructor(
  ...
  MC::Rooted<JSObject*> underlyingSinkObj(
      aGlobal.Context(),
...
already_AddRefed<Promise> WritableStreamAbort(JSContext* aCx,
  ...
  MC::Rooted<JS::Value> reason(aCx, aReason);
