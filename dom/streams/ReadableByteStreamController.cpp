...
ReadableByteStreamControllerGetBYOBRequest(
  ...
  if (!aController->GetByobRequest() &&
    ...
    MC::Rooted<JSObject*> buffer(aCx, firstDescriptor->Buffer());
...
void ReadableByteStreamControllerEnqueueClonedChunkToQueue(
  ...
  // %ArrayBuffer%).
  aRv.MightThrowJSException();
  MC::Rooted<JSObject*> cloneResult(
...
void ReadableByteStreamControllerEnqueueDetachedPullIntoToQueue(
  ...
  if (aPullIntoDescriptor->BytesFilled() > 0) {
    MC::Rooted<JSObject*> buffer(aCx, aPullIntoDescriptor->Buffer());
...
void ReadableByteStreamControllerCommitPullIntoDescriptor(
  ...
  MC::Rooted<JSObject*> filledView(
      aCx, ReadableByteStreamControllerConvertPullIntoDescriptor(
               aCx, pullIntoDescriptor, aRv));
  if (aRv.Failed()) {
    return;
  }
  MC::Rooted<JS::Value> filledViewValue(aCx, JS::ObjectValue(*filledView));
...
MOZ_CAN_RUN_SCRIPT void ReadableByteStreamControllerFillReadRequestFromQueue(
  ...
  aRv.MightThrowJSException();
  MC::Rooted<JSObject*> buffer(aCx, entry->Buffer());
  MC::Rooted<JSObject*> view(
  ...
  MC::Rooted<JS::Value> viewValue(aCx, JS::ObjectValue(*view));
...
void ReadableByteStreamControllerEnqueue(
  ...
  // Step 7.
  MC::Rooted<JSObject*> transferredBuffer(aCx,
  ...
  if (!aController->PendingPullIntos().isEmpty()) {
    ...
    // Step 8.2
    MC::Rooted<JSObject*> pendingBuffer(aCx, firstPendingPullInto->Buffer());
  ...
  if (ReadableStreamHasDefaultReader(stream)) {
    ...
    if (ReadableStreamGetNumReadRequests(stream) == 0) {
      ...
      // transferredBuffer, byteOffset, byteLength »).
      MC::Rooted<JSObject*> transferredView(
      ...
      MC::Rooted<JS::Value> transferredViewValue(
...
void ReadableByteStreamController::Enqueue(MCContext* aCx,
                                           ...
                                           ErrorResult& aRv) {
  // Step 1.
  MC::Rooted<JSObject*> chunk(aCx, aChunk.Obj());
...
void ReadableByteStreamController::PullSteps(MCContext* aCx,
  ...
  if (autoAllocateChunkSize) {
    ...
    if (!buffer) {
      // Step 5.2.1
      MC::Rooted<JS::Value> bufferError(aCx);
...
JSObject* ReadableByteStreamControllerConvertPullIntoDescriptor(
  ...
  aRv.MightThrowJSException();
  MC::Rooted<JSObject*> srcBuffer(aCx, pullIntoDescriptor->Buffer());
  MC::Rooted<JSObject*> buffer(aCx, TransferArrayBuffer(aCx, srcBuffer));
  if (!buffer) {
    aRv.StealExceptionFromJSContext(aCx);
    return nullptr;
  }
...
static void ReadableByteStreamControllerRespondInReadableState(
  ...
  if (remainderSize > 0) {
    ...
    MC::Rooted<JSObject*> pullIntoBuffer(aCx, aPullIntoDescriptor->Buffer());
    ReadableByteStreamControllerEnqueueClonedChunkToQueue(
...
void ReadableByteStreamControllerRespondWithNewView(
  ...
  MC::Rooted<JSObject*> transferedBuffer(
...
bool ReadableByteStreamControllerFillPullIntoDescriptorFromQueue(
  ...
  while (totalBytesToCopyRemaining > 0) {
    ...
    //            bytesToCopy).
    MC::Rooted<JSObject*> descriptorBuffer(aCx, aPullIntoDescriptor->Buffer());
    MC::Rooted<JSObject*> queueBuffer(aCx, headOfQueue->Buffer());
...
void ReadableByteStreamControllerPullInto(
  ...
  MC::Rooted<JSObject*> bufferResult(
      aCx, TransferArrayBuffer(aCx, viewedArrayBuffer));

  // Step 8. If bufferResult is an abrupt completion,
  if (!bufferResult) {
    MC::Rooted<JS::Value> pendingException(aCx);
  ...
  MC::Rooted<JSObject*> buffer(aCx, bufferResult);
  ...
  if (stream->State() == ReadableStream::ReaderState::Closed) {
    ...
    MC::Rooted<JSObject*> pullIntoBuffer(aCx, pullIntoDescriptor->Buffer());
    MC::Rooted<JSObject*> emptyView(
        aCx,
    ...
    MC::Rooted<JS::Value> emptyViewValue(aCx, JS::ObjectValue(*emptyView));
