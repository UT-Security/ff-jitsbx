...
bool StructuredCloneHolder::WriteFullySerializableObjects(
  ...
  // unwrap here.
  JS::sandbox::Rooted<JSObject*> obj(aCx, js::CheckedUnwrapStatic(aObj));
  if (!obj) {
...
JSObject* StructuredCloneHolder::CustomReadHandler(
  ...
  if (StaticPrefs::dom_media_webcodecs_enabled() &&
      ...
      CloneScope() == StructuredCloneScope::SameProcess) {
    JS::sandbox::Rooted<JSObject*> global(aCx, mGlobal->GetGlobalJSObject());
...
StructuredCloneHolder::CustomReadTransferHandler(
  ...
  if (StaticPrefs::dom_media_webcodecs_enabled() &&
    ...
    JS::sandbox::Rooted<JSObject*> globalObj(aCx, mGlobal->GetGlobalJSObject());
