...
void SerializedStackHolder::WriteStack(JSContext* aCx,
  ...
  JS::sandbox::Rooted<JS::Value> stackValue(aCx, JS::ObjectValue(*aStack));
...
JSObject* SerializedStackHolder::ReadStack(JSContext* aCx) {
  ...
  JS::sandbox::Rooted<JS::Value> stackValue(aCx);
...
void ConvertSerializedStackToJSON(UniquePtr<SerializedStackHolder> aStackHolder,
  ...
  JS::sandbox::Rooted<JSObject*> savedFrame(cx, aStackHolder->ReadStack(cx));
  if (!savedFrame) {
    return;
  }

  JS::sandbox::Rooted<JSObject*> converted(cx);
  ...
  JS::sandbox::Rooted<JS::Value> convertedValue(cx, JS::ObjectValue(*converted));
