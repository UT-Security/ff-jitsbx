...
bool SetStringProperty(JSContext* cx, JS::Handle<JSObject*> aObject,
  ...
  JS::sandbox::Rooted<JS::Value> valValue(cx, JS::StringValue(strValue));
...
bool OSFileConstantsService::DefineOSFileConstants(
  ...
  JS::sandbox::Rooted<JSObject*> objOS(aCx);
  if (!(objOS = GetOrCreateObjectProperty(aCx, aGlobal, "OS"))) {
    return false;
  }
  JS::sandbox::Rooted<JSObject*> objConstants(aCx);
  ...
  JS::sandbox::Rooted<JSObject*> objLibc(aCx);
  ...
  JS::sandbox::Rooted<JSObject*> objWin(aCx);
  ...
  JS::sandbox::Rooted<JSObject*> objSys(aCx);
...
OSFileConstantsService::Init(JSContext* aCx) {
  ...
  JS::sandbox::Rooted<JSObject*> targetObj(aCx);
