 ...
 public:
  ...
  virtual bool defineProperty(MCContext* cx, JS::HandleObject proxy,
    ...
    return UNSAFE_getProxyHandler()->js::ForwardingProxyHandler::defineProperty(
        cx->cx_, proxy, id, desc, *result.INTERNAL_unverified_safe());
  }
  ...
  virtual bool delete_(MCContext* cx, JS::HandleObject proxy, JS::HandleId id,
    ...
    return UNSAFE_getProxyHandler()->js::ForwardingProxyHandler::delete_(
        cx->cx_, proxy, id, *result.INTERNAL_unverified_safe());
  }
  ...
  virtual bool setPrototype(
      MCContext* cx, JS::HandleObject proxy, JS::HandleObject proto,
      MC::Tainted<JS::ObjectOpResult*> result) const override {
  ...
  virtual bool has(MCContext* cx, JS::HandleObject proxy, JS::HandleId id,
    ...
    return UNSAFE_getProxyHandler()->js::ForwardingProxyHandler::has(cx->cx_, proxy,
                                                                     id, bp.INTERNAL_unverified_safe());
  }
  ...
  virtual bool getBuiltinClass(MCContext* cx, JS::HandleObject proxy,
    ...
    return UNSAFE_getProxyHandler()
        ->js::ForwardingProxyHandler::getBuiltinClass(cx->cx_, proxy, cls.INTERNAL_unverified_safe());
  }

  virtual bool isArray(MCContext* cx, JS::HandleObject proxy,
                       MC::Tainted<JS::IsArrayAnswer*> answer) const override {
    return UNSAFE_getProxyHandler()->js::ForwardingProxyHandler::isArray(
        cx->cx_, proxy, answer.INTERNAL_unverified_safe());
  }
...
#define DEFINE_WRAPPER_OPS_CALLBACKS(ExternalWrapper)                                        \
 static MC::Tainted<bool> finalizeInBackgroundCb(MC::AppPointer<const void*> p, const JS::Value& priv) {  \
   auto* h = static_cast<const ExternalWrapper*>(p.UNSAFE_unverified());                     \
 ...
 static MC::Tainted<bool> dynamicCheckedUnwrapAllowedCb(MC::AppPointer<const void*> p, JS::HandleObject obj,              \
                                           MC::Tainted<JSContext*> tcx) {                                  \
   auto* h = static_cast<const ExternalWrapper*>(p.UNSAFE_unverified());                                         \
   MCContext* cx = tcx.copy_and_verify_address(MC_VerifyContext);                                                  \
 ...
 static const js::sandbox::WrapperOps* ops() {                                               \
   static const js::sandbox::WrapperOps __ops = {                                            \
       ...
       MC::Sandbox::RegisterTaintedCallback(dynamicCheckedUnwrapAllowedCb).UNSAFE_get(),                                                        \
   };                                                                                                                                    \
   return &__ops;                                                                                                                        \
 }
...
public:
 ...
 virtual bool delete_(MCContext* cx, JS::HandleObject proxy, JS::HandleId id,
                      MC::Tainted<JS::ObjectOpResult*> result) const override {
   return UNSAFE_getWrapper()->js::CrossCompartmentWrapper::delete_(
       cx->cx_, proxy, id, *result.INTERNAL_unverified_safe());
 }
 ...
 virtual bool hasOwn(MCContext* cx, JS::HandleObject proxy, JS::HandleId id,
                     MC::Tainted<bool*> bp) const override {
   return UNSAFE_getWrapper()->js::CrossCompartmentWrapper::hasOwn(
       cx->cx_, proxy, id, bp.INTERNAL_unverified_safe());
 }
...
class OpaqueCrossCompartmentWrapper : public CrossCompartmentWrapper {
 ...
 public:
  ...
  virtual bool hasOwn(MCContext* cx, JS::HandleObject proxy, JS::HandleId id,
                      MC::Tainted<bool*> bp) const override {
    return UNSAFE_getWrapper()->js::OpaqueCrossCompartmentWrapper::hasOwn(
        cx->cx_, proxy, id, bp.INTERNAL_unverified_safe());
  }
  ...
  virtual bool getBuiltinClass(MCContext* cx, JS::HandleObject proxy,
                               MC::Tainted<js::ESClass*> cls) const override {
    return UNSAFE_getWrapper()
        ->js::OpaqueCrossCompartmentWrapper::getBuiltinClass(cx->cx_, proxy, cls.INTERNAL_unverified_safe());
  }
...
class SecurityWrapper : public Base {
 ...
 public:
  ...
  virtual bool setPrototype(
      MCContext* cx, JS::HandleObject proxy, JS::HandleObject proto,
      MC::Tainted<JS::ObjectOpResult*> result) const override {
    return UNSAFE_getWrapper()->Unsafe::setPrototype(
        cx->cx_, proxy, proto, *result.INTERNAL_unverified_safe());
  }
  ...
  virtual bool getBuiltinClass(MCContext* cx, JS::HandleObject proxy,
                               MC::Tainted<js::ESClass*> cls) const override {
    return UNSAFE_getWrapper()->Unsafe::getBuiltinClass(cx->cx_, proxy, cls.INTERNAL_unverified_safe());
  }

  virtual bool isArray(MCContext* cx, JS::HandleObject proxy,
                       MC::Tainted<JS::IsArrayAnswer*> answer) const override {
    return UNSAFE_getWrapper()->Unsafe::isArray(cx->cx_, proxy, answer.INTERNAL_unverified_safe());
  }
...
inline bool RecomputeWrappers(MCContext* cx,
                              const mc::CompartmentFilter& sourceFilter,
                              const mc::CompartmentFilter& targetFilter) {
  return RecomputeWrappers(cx->cx_, *sourceFilter.inner_, *targetFilter.inner_);
}
