...
typedef void (*UpdateFn)(uintptr_t start, size_t len, struct MMInfo info,
                         void* udata);
...
uintptr_t mm_mapat(struct MMAddrSpace* mm, uintptr_t addr, size_t len, int prot,
...
uintptr_t mm_mapat_cb(struct MMAddrSpace* mm, uintptr_t addr, size_t len,
...
int mm_unmap(struct MMAddrSpace* mm, uintptr_t addr, size_t len);
...
int mm_unmap_cb(struct MMAddrSpace* mm, uintptr_t addr, size_t len,
...
bool mm_querypage(struct MMAddrSpace* mm, uintptr_t addr, struct MMInfo* info);
...
int mm_protect(struct MMAddrSpace* mm, uintptr_t addr, size_t len, int prot);
...
int mm_protect_cb(struct MMAddrSpace* mm, uintptr_t addr, size_t len, int prot,
                  UpdateFn ufn, void* udata);
