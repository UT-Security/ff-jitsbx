...
GleanEvent::Record(JS::Handle<JS::Value> aExtra, JSContext* aCx) {
  ...
  JS::sandbox::Rooted<JSObject*> obj(aCx, &aExtra.toObject());
...
GleanEvent::TestGetValue(const nsACString& aStorageName, JSContext* aCx,
  ...
  JS::sandbox::Rooted<JSObject*> eventArray(aCx, JS::NewArrayObject(aCx, count));
  ...
  for (size_t i = 0; i < count; i++) {
    ...
    JS::sandbox::Rooted<JSObject*> eventObj(aCx, JS_NewPlainObject(aCx));
    ...
    JS::sandbox::Rooted<JS::Value> catStr(aCx);
    ...
    JS::sandbox::Rooted<JS::Value> nameStr(aCx);
    ...
    JS::sandbox::Rooted<JSObject*> extraObj(aCx, JS_NewPlainObject(aCx));
    ...
    for (auto pair : value->mExtra) {
      ...
      JS::sandbox::Rooted<JS::Value> valStr(aCx);
