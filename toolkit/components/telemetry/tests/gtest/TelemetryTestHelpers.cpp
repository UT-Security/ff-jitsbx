...
void CheckUintScalar(const char* aName, JSContext* aCx,
  ...
  JS::sandbox::Rooted<JSObject*> scalarObj(aCx, &aSnapshot.toObject());
...
void CheckKeyedUintScalar(const char* aName, const char* aKey, JSContext* aCx,
  ...
  JS::sandbox::Rooted<JS::Value> keyedScalar(aCx);
  JS::sandbox::Rooted<JSObject*> scalarObj(aCx, &aSnapshot.toObject());
...
void CheckNumberOfProperties(const char* aName, JSContext* aCx,
  ...
  JS::sandbox::Rooted<JSObject*> keyedScalarObj(aCx, &keyedScalar.toObject());
...
bool EventPresent(JSContext* aCx, const JS::sandbox::RootedValue& aSnapshot,
  ...
  JS::sandbox::Rooted<JSObject*> arrayObj(aCx, &aSnapshot.toObject());
  ...
  for (uint32_t arrayIdx = 0; arrayIdx < arrayLength; ++arrayIdx) {
    ...
    JS::sandbox::Rooted<JSObject*> eventArray(aCx, &element.toObject());
...
void GetEventSnapshot(JSContext* aCx, JS::MutableHandle<JS::Value> aResult,
  ...
  JS::sandbox::Rooted<JS::Value> eventSnapshot(aCx);
  nsresult rv;
  ...
  JS::sandbox::Rooted<JS::Value> processEvents(aCx);
  JS::sandbox::Rooted<JSObject*> eventObj(aCx, &eventSnapshot.toObject());
...
void GetScalarsSnapshot(bool aKeyed, JSContext* aCx,
  ...
  JS::sandbox::Rooted<JS::Value> scalarsSnapshot(aCx);
  nsresult rv;
  ...
  JS::sandbox::Rooted<JS::Value> processScalars(aCx);
  JS::sandbox::Rooted<JSObject*> scalarObj(aCx, &scalarsSnapshot.toObject());
...
void GetAndClearHistogram(JSContext* cx, nsCOMPtr<nsITelemetry> mTelemetry,
  ...
  JS::sandbox::Rooted<JS::Value> testHistogram(cx);
  nsresult rv =
  ...
  JS::sandbox::Rooted<JSObject*> testHistogramObj(cx, &testHistogram.toObject());
...
void GetProperty(JSContext* cx, const char* name, JS::Handle<JS::Value> valueIn,
  ...
  JS::sandbox::Rooted<JS::Value> property(cx);
  JS::sandbox::Rooted<JSObject*> valueInObj(cx, &valueIn.toObject());
...
void GetSnapshots(JSContext* cx, nsCOMPtr<nsITelemetry> mTelemetry,
                  ...
                  bool is_keyed) {
  JS::sandbox::Rooted<JS::Value> snapshots(cx);
  ...
  JS::sandbox::Rooted<JS::Value> snapshot(cx);
