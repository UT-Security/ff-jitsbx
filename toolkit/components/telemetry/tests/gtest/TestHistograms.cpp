...
TEST_F(TelemetryTestFixture, AccumulateKeyedCountHistogram) {
  ...
  JS::sandbox::Rooted<JS::Value> expectedKeyData(cx.GetJSContext());
...
TEST_F(TelemetryTestFixture, TestKeyedKeysHistogram) {
  ...
  JS::sandbox::Rooted<JS::Value> testHistogram(cx.GetJSContext());
  JS::sandbox::Rooted<JS::Value> rval(cx.GetJSContext());
  ...
  JS::sandbox::Rooted<JS::Value> scalarsSnapshot(cx.GetJSContext());
...
TEST_F(TelemetryTestFixture, AccumulateKeyedCategoricalHistogram) {
  ...
  JS::sandbox::Rooted<JS::Value> sample(cx.GetJSContext());
  ...
  // the histogram.
  JS::sandbox::Rooted<JS::Value> sampleValues(cx.GetJSContext());
  GetProperty(cx.GetJSContext(), "values", sample, &sampleValues);
  // Get the value for the label we care about
  JS::sandbox::Rooted<JS::Value> sampleValue(cx.GetJSContext());
  GetElement(
      cx.GetJSContext(),
      static_cast<uint32_t>(
          Telemetry::LABELS_TELEMETRY_TEST_KEYED_CATEGORICAL::CommonLabel),
  ...
  JS::sandbox::Rooted<JS::Value> otherSample(cx.GetJSContext());
  ...
  JS::sandbox::Rooted<JS::Value> otherValues(cx.GetJSContext());
  GetProperty(cx.GetJSContext(), "values", otherSample, &otherValues);
  // Get the value for the label we care about
  JS::sandbox::Rooted<JS::Value> otherValue(cx.GetJSContext());
  GetElement(
      cx.GetJSContext(),
      static_cast<uint32_t>(
          Telemetry::LABELS_TELEMETRY_TEST_KEYED_CATEGORICAL::CommonLabel),
...
TEST_F(TelemetryTestFixture, AccumulateLinearHistogram_MultipleSamples) {
  ...
  // index 1
  JS::sandbox::Rooted<JS::Value> count(cx.GetJSContext());
...
TEST_F(TelemetryTestFixture, AccumulateLinearHistogram_DifferentSamples) {
  ...
  JS::sandbox::Rooted<JS::Value> countFirst(cx.GetJSContext());
  JS::sandbox::Rooted<JS::Value> countLast(cx.GetJSContext());
...
TEST_F(TelemetryTestFixture, TestKeyedKeysHistogram_MultipleSamples) {
  ...
  // Get "testkey" property from histogram and check that it stores the correct
  // data.
  JS::sandbox::Rooted<JS::Value> testKeyData(cx.GetJSContext());
  ...
  JS::sandbox::Rooted<JS::Value> countFalse(cx.GetJSContext());
  JS::sandbox::Rooted<JS::Value> countTrue(cx.GetJSContext());
  JS::sandbox::Rooted<JS::Value> countOther(cx.GetJSContext());
  ...
  // undefined.
  JS::sandbox::Rooted<JS::Value> commonKeyData(cx.GetJSContext());
  ...
  JS::sandbox::Rooted<JS::Value> notAllowedKeyData(cx.GetJSContext());
...
TEST_F(TelemetryTestFixture,
  ...
  // in the histogram.
  JS::sandbox::Rooted<JS::Value> sampleKeyValues(cx.GetJSContext());
  GetProperty(cx.GetJSContext(), "values", sample, &sampleKeyValues);

  // Get the count of CommonLabel
  JS::sandbox::Rooted<JS::Value> commonLabelValue(cx.GetJSContext());
  GetElement(
      cx.GetJSContext(),
      static_cast<uint32_t>(
          Telemetry::LABELS_TELEMETRY_TEST_KEYED_CATEGORICAL::CommonLabel),
  ...
  JS::sandbox::Rooted<JS::Value> label2Value(cx.GetJSContext());
  GetElement(cx.GetJSContext(),
             static_cast<uint32_t>(
                 Telemetry::LABELS_TELEMETRY_TEST_KEYED_CATEGORICAL::Label2),
