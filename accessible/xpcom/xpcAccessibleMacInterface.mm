...
nsresult xpcAccessibleMacInterface::NSObjectToJsValue(id aObj, JSContext* aCx,
  ...
  if (!aObj) {
    ...
    JS::sandbox::RootedVector<JS::Value> v(aCx);
    ...
    JS::sandbox::RootedObject obj(aCx, JS_NewPlainObject(aCx));
    for (NSString* key in aObj) {
      nsAutoString strKey;
      nsCocoaUtils::GetStringForNSString(key, strKey);
      JS::sandbox::RootedValue value(aCx);
...
id xpcAccessibleMacInterface::JsValueToNSObject(JS::HandleValue aValue, JSContext* aCx,
  ...
  *aResult = NS_OK;
  if (aValue.isInt32()) {
    ...
    JS::sandbox::Rooted<JSObject*> obj(aCx, aValue.toObjectOrNull());
...
id xpcAccessibleMacInterface::JsValueToNSValue(JS::HandleObject aObject, JSContext* aCx,
  ...
  *aResult = NS_ERROR_FAILURE;
  ...
  JS::sandbox::Rooted<JSObject*> value(aCx, valueValue.toObjectOrNull());
  ...
  if (valueType.EqualsLiteral("NSRange")) {
    ...
    JS::sandbox::RootedValue locationValue(aCx);
    JS_GetElement(aCx, value, 0, &locationValue);
    JS::sandbox::RootedValue lengthValue(aCx);
...
id xpcAccessibleMacInterface::JsValueToSpecifiedNSObject(JS::HandleObject aObject, JSContext* aCx,
  ...
  *aResult = NS_ERROR_FAILURE;
  ...
  JS::sandbox::Rooted<JSObject*> object(aCx, objectValue.toObjectOrNull());
  ...
  if (objectType.EqualsLiteral("NSDictionary")) {
    ...
    for (size_t i = 0, n = ids.length(); i < n; i++) {
      nsresult rv = NS_OK;
      // get current key
      JS::sandbox::RootedValue currentKey(aCx);
      ...
      JS::sandbox::RootedValue currentValue(aCx);
