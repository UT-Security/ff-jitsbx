...
nsresult BoxString(JSContext* aCx, JS::Handle<JS::Value> aData,
  ...
  JS::sandbox::Rooted<JSString*> str(aCx, aData.toString());
...
nsresult BoxObject(JSContext* aCx, JS::Handle<JS::Value> aData,
  ...
  JS::sandbox::Rooted<JSObject*> obj(aCx, &aData.toObject());
  ...
  for (size_t i = 0; i < ids.length(); i++) {
    const JS::sandbox::RootedId id(aCx, ids[i]);
    JS::sandbox::Rooted<JS::Value> idVal(aCx);
    ...
    JS::sandbox::Rooted<JSString*> idStr(aCx, JS::ToString(aCx, idVal));
