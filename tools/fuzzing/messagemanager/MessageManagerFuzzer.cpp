...
void MessageManagerFuzzer::MutateObject(JSContext* aCx,
  ...
  JS::sandbox::Rooted<JSObject*> object(aCx, &aValue.toObject());
  ...
  for (size_t i = 0, n = ids.length(); i < n; i++) {
    ...
    JS::sandbox::Rooted<JS::Value> propertyValue(aCx);
    JS_GetPropertyById(aCx, object, ids[i], &propertyValue);

    JS::sandbox::Rooted<JS::Value> newPropValue(aCx);
...
bool MessageManagerFuzzer::MutateValue(
  ...
  if (aValue.isString()) {
    ...
    JS::sandbox::Rooted<JSString*> rootedValue(aCx, aValue.toString());
...
bool MessageManagerFuzzer::Mutate(JSContext* aCx, const nsAString& aMessageName,
  ...
  JS::sandbox::Rooted<JS::Value> scdContent(aCx);
  ...
  JS::sandbox::Rooted<JS::Value> scdMutationContent(aCx);
  bool isMutated =
  ...
  if (isMutated) {
    JS::sandbox::Rooted<JSString*> str(aCx, JS_ValueToSource(aCx, scdMutationContent));
